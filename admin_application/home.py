...
class home(util.window):
	def __init__(self, server):
		...
		label_info = Label(user_frame, text="Welcome "+ udata['fname'] +" "+ udata['lname'])
		...
		label_meet = Label(registermeet_frame, justify=LEFT, text="The group runs the\nlargest hotel chain\nin the country. The\nvery    first     hotel\n'The Seven Seas'  ,\nwhich     is     564\nyears     old     still\nfunctions     in \nBangalore.")
		label_meet.place(x=x-17, y = y+80)
